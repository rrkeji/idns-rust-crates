...
impl RunnercDID {
    ...
    pub const METHOD: &'static str = "idns";
...
mod tests {
    ...
    fn test_parse_did_url_valid() {
        ...
        assert!(
            RunnercDIDUrl::parse(format!("did:idns:{}?somequery=somevalue#fragment", TAG)).is_ok()
        );
        ...
        assert!(RunnercDIDUrl::parse(format!(
            "did:idns:main:{}?somequery=somevalue#fragment",
            TAG
        ))
        .is_ok());
        ...
        assert!(
            RunnercDIDUrl::parse(format!("did:idns:dev:{}?somequery=somevalue#fragment", TAG))
                .is_ok()
        );
        ...
        assert!(
            RunnercDIDUrl::parse(format!("did:idns:custom:{}?somequery=somevalue", TAG)).is_ok()
        );
        assert!(RunnercDIDUrl::parse(format!(
            "did:idns:custom:{}?somequery=somevalue#fragment",
            TAG
        ))
        .is_ok());
    }
